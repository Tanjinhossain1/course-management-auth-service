...
const globalErrorHandler = (err, req, res, next) => {
  ...
  let errorMessages = [];
  if (
    (err === null || err === void 0 ? void 0 : err.name) === 'ValidatorError'
  ) {
    /* ************ mongoose validation Error handler *********** */
    const getValidateError = (0, handleValidationError_1.handleValidationError)(
      err
    );
    ...
    /* ************ Cast Error handler *********** */
    const getValidationCastError = (0,
    handleValidationError_1.validationCastError)(err);
    ...
    const getValidateZodError = (0, handleValidationError_1.validationZodError)(
      err
    );
