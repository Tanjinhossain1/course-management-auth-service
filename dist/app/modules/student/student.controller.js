...
exports.deleteSingleStudent =
  exports.updateSingleAccountStudentsController =
  exports.getSingleAccountStudentsController =
  exports.getAllStudentController =
    void 0;
...
exports.getAllStudentController = (0, clearableAsync_1.clearableAsync)(
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      const result = yield (0, student_service_1.getAllStudentServices)(
        filters,
        paginationOption
      );
...
exports.getSingleAccountStudentsController = (0,
...
exports.updateSingleAccountStudentsController = (0,
clearableAsync_1.clearableAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const updateData = req.body;
    const result = yield (0, student_service_1.updateSingleStudentService)(
      id,
      updateData
    );
    (0, sendResponce_1.sendResponse)(res, {
...
exports.deleteSingleStudent = (0, clearableAsync_1.clearableAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
