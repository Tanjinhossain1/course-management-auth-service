...
exports.deleteAcademicSemester =
  exports.updateSingleAccountSemestersController =
  exports.getSingleAccountSemestersController =
  exports.getAllAccountSemestersController =
...
exports.createAcademicSemesterController = (0, clearableAsync_1.clearableAsync)(
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const academicSemesterData = req.body;
      const result = yield (0,
      academicSemester_service_1.createAcademicSemester)(academicSemesterData);
...
exports.getAllAccountSemestersController = (0, clearableAsync_1.clearableAsync)(
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      const result = yield (0,
      academicSemester_service_1.getAllSemesterServices)(
        filters,
        paginationOption
      );
      (0, sendResponce_1.sendResponse)(res, {
...
exports.getSingleAccountSemestersController = (0,
...
exports.updateSingleAccountSemestersController = (0,
clearableAsync_1.clearableAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const updateData = req.body;
    const result = yield (0,
    academicSemester_service_1.updateSingleSemesterService)(id, updateData);
    (0, sendResponce_1.sendResponse)(res, {
      statusCode: http_status_1.default.OK,
      success: true,
      message: 'SuccessFully Getting Semester ',
...
exports.deleteAcademicSemester = (0, clearableAsync_1.clearableAsync)(
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const id = req.params.id;
      const result = yield (0,
      academicSemester_service_1.deleteSingleSemesterService)(id);
      (0, sendResponce_1.sendResponse)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
