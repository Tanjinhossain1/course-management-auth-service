...
const createStudentService = (student, user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // set role
    user.role = 'student';
    const findAcademicSemester = yield academicSemester_model_1.academicSemester.findById(student.academicSemester);
    // generate student id
    ...
    try {
        ...
        student.id = id;
        user.id = id;
        const createStudent = yield student_model_1.StudentModel.create([student], { session });
